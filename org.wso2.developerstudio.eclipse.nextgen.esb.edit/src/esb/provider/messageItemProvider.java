...
/**
 * This is the item provider adapter for a {@link esb.message} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class messageItemProvider extends ElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addInLifeLinePropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the In Life Line feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addInLifeLinePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_message_inLifeLine_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_message_inLifeLine_feature", "_UI_message_type"),
				 EsbPackage.Literals.MESSAGE__IN_LIFE_LINE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EsbPackage.Literals.MESSAGE__NAME,
				 true,
				 false,
				 false,
