...
/**
 * This is the item provider adapter for a {@link esb.Lifeline} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LifelineItemProvider extends ElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Lifeline_inMessage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Lifeline_inMessage_feature", "_UI_Lifeline_type"),
				 EsbPackage.Literals.LIFELINE__IN_MESSAGE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EsbPackage.Literals.LIFELINE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EsbPackage.Literals.LIFELINE__OUT_MESSAGE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EsbPackage.Literals.LIFELINE__OUT_MESSAGE,
				 EsbFactory.eINSTANCE.createmessage()));
	}
