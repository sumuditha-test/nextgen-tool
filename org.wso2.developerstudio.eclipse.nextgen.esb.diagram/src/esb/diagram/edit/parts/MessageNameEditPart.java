...
import esb.diagram.edit.policies.NextGenESBTextSelectionEditPolicy;
...
public class MessageNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				NextGenESBVisualIDRegistry.getType(esb.diagram.edit.parts.MessageNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new NextGenESBTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return NextGenESBElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = NextGenESBParserProvider.getParser(NextGenESBElementTypes.Message_4001, getParserElement(),
					NextGenESBVisualIDRegistry.getType(esb.diagram.edit.parts.MessageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, NextGenESBEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	...
	private void handleNonResizableRefreshBoundS() {
		...
		int dy = ((Integer) getStructuralFeatureValue(NotationPackage.eINSTANCE.getLocation_Y()))
			.intValue();
		Point offset = new Point(dx/2, dy/2);
		if (getParent() instanceof AbstractConnectionEditPart) {
			((AbstractGraphicalEditPart) getParent()).setLayoutConstraint(this,
