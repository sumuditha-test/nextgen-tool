...
public class LifelineNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = NextGenESBParserProvider.getParser(NextGenESBElementTypes.Lifeline_2001, getParserElement(),
					NextGenESBVisualIDRegistry.getType(esb.diagram.edit.parts.LifelineNameEditPart.VISUAL_ID));
		}
		return parser;
	}
